...
import gov.dhs.uscis.odos.repository.LocationRepository;
import gov.dhs.uscis.odos.service.LocationService;
import gov.dhs.uscis.odos.service.dto.LocationDTO;
import gov.dhs.uscis.odos.service.mapper.LocationMapper;
...
@SpringBootTest(classes = Odosiims1ServiceApp.class)
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_COST_RATE = "AAAAAAAAAA";
    private static final String UPDATED_COST_RATE = "BBBBBBBBBB";
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getCostRate()).isEqualTo(DEFAULT_COST_RATE);
        assertThat(testLocation.getAvailability()).isEqualTo(DEFAULT_AVAILABILITY);
    }
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].costRate").value(hasItem(DEFAULT_COST_RATE.toString())))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.costRate").value(DEFAULT_COST_RATE.toString()))
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getCostRate()).isEqualTo(UPDATED_COST_RATE);
        assertThat(testLocation.getAvailability()).isEqualTo(UPDATED_AVAILABILITY);
    }
