        ...
        stage('Build Container') {
            steps {
              script{
                ...
                Common.buildContainer('odosiisvc1')
              }
            }
        }
        stage('Twistlock Scan') {
            steps {
              script{
                ...
                Common.twistlock('docker.lassiterdynamics.com:5000', 'odosiisvc1','latest')
              }
            }
        }
        stage('Push Container') {
            steps {
              script{
                ...
                Common.pushContainer('odosiisvc1')
              }
            }
        }
        stage('Test Deploy') {
            steps {
              script{
                ...
                Common.deployToOpenShift('odos-test','odosiisvc1','latest')
              }
            }
        }
        stage('FT') {
